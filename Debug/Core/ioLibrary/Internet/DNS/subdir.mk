...
C_SRCS += \
../Core/ioLibrary/Internet/DNS/dns.c 

OBJS += \
./Core/ioLibrary/Internet/DNS/dns.o 

C_DEPS += \
./Core/ioLibrary/Internet/DNS/dns.d 


# Each subdirectory must supply rules for building sources it contributes
Core/ioLibrary/Internet/DNS/dns.o: ../Core/ioLibrary/Internet/DNS/dns.c Core/ioLibrary/Internet/DNS/subdir.mk
