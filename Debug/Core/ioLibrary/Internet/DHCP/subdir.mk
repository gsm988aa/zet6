...
C_SRCS += \
../Core/ioLibrary/Internet/DHCP/dhcp.c 

OBJS += \
./Core/ioLibrary/Internet/DHCP/dhcp.o 

C_DEPS += \
./Core/ioLibrary/Internet/DHCP/dhcp.d 


# Each subdirectory must supply rules for building sources it contributes
Core/ioLibrary/Internet/DHCP/dhcp.o: ../Core/ioLibrary/Internet/DHCP/dhcp.c Core/ioLibrary/Internet/DHCP/subdir.mk
